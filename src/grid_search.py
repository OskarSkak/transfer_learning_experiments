...
def transfer_learning_suite():
    ...
    # batch_sizes = [32, 64]
    batch_sizes = [32, 64]
    learning_rates = [0.000011] # , 0.0001] # remove 0.001
    # optimizers = ['sgd', 'adam']
    optimizers = ['adam'] # SGd sucks
    pretrained_models = ['Xception', 'VGG16', 'ResNet152V2', 'InceptionResNetV2', 'MobileNetV2'] #NasNet fuckede - undersøg
    # pretrained_models = ['Xception']
    # pretrained_models = ['InceptionResNetV2']
    # epochs = [50, 100] # remove 30
    epochs = [100] # 50 doesent matter with early stopping
    # dropout_rates = [0, 0.15, 0.3]
    dropout_rates = [0, 0.15] # 0.3 sucks
