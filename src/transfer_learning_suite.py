...
class TransferLearningModel():
    ...
    def visualize_arch(self):
        import visualkeras
        visualkeras.layered_view(self.base_model).show()
    
    def visualize_arch_2(self, name):
        from tensorflow.keras.utils import plot_model
        plot_model(self.model, to_file=f'/tmp/{name}.png')
...
def main():
    ...
    print(f'*************************{model_name}************************')
    # model.m2tex()
    model.m2texbase(model_name)
    # model.visualize_arch_2(model_name)
    ...
    # diagnostic.train_samples = 3000
    # diagnostic.test_samples = 600
    # diagnostic.patience = 10
