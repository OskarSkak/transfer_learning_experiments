...
def m2texbase(name, model):
    ...
    print('\n\n\n')
    table.to_csv(f'./models_csv/RAD{name}.csv', encoding='utf-8', index=False)
...
def main():
    ...
    trainX, trainY, testX, testY = DataUtils().api_load_medical_data(100, 100)
